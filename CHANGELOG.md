...
### Fixed
- Fixed Word document generation to properly create .docx files using browser-compatible methods
- Resolved issue with corrupted Word documents when downloading results
